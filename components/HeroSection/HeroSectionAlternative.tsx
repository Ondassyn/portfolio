...
const HeroSectionAlternative = () => {
  ...
  return (
    <div
      ...
      // bg-transparent so GridCanvas shows through at low opacity
      className="relative w-full h-screen bg-transparent overflow-hidden cursor-pointer"
    >
